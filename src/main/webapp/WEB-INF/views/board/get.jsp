    			...
    			<div class="box box-primary">
					...
					<!-- 절대경로 /board/register -->
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="writer" id="writer" value="${getBno.writer}" readonly>
						</div>
						<div class="form-group">
							<label>Content</label>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="mdfdate" id="mdfdate" value='<fmt:formatDate value="${getBno.updateddate}" pattern="yyyy-MM-dd"/>' readonly>
						</div>
