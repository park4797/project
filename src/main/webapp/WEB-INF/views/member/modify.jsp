      ...
      <form role="form" id="modifyForm" method="post" action="/member/modify">
        <div class="box-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-8">
              <input type="text" class="form-control" name="user_zipcode" id="sample2_postcode" value="${memberVO.user_zipcode}">
            </div>
            <div class="col-2">
          ...
          <div class="form-group row">
            ...
            <div class="col-10">
              <input type="text" class="form-control" name="user_deaddr" id="sample2_detailAddress" value="${memberVO.user_deaddr}">
        ...
        <div class="box-footer">
          <button type="button" id="btn_user_modify" class="btn btn-primary">수정</button>
        </div>
      </form>
    </div>
...
<script>
  ...
  <script>
    $(document).ready(function() {
      ...
      let userModify = $("#modifyForm");

      $("#btn_user_modify").click(function() {
        userModify.submit(); // 폼전송
      })
    });
  </script>
  </body>
